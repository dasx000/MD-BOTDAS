...
(function () {
  ...
  */
  ...
  Yd.fa = 'dataLayer';
  Yd.Rh =
    'ChAIgPvEnQYQ0Mmi4brnrc1CEicAGvQBy07hJc0AFecb12MvL1mDBuNvT3emLf6HFVUwsJcfl8DIxLQaAnys';
  var ae = {
      __cl: !0,
      __ecl: !0,
      __ehl: !0,
  ...
  var Tg = { M: 'UA-73910310-13', Hb: '' },
    Ug = { th: 'UA-73910310-13', uh: 'UA-73910310-13' };
  Tg.We = Aa('');
  var Vg = function () {
  ...
  function zi(a, b) {
    ...
    var d = Ya('GTM'),
      ...
      y = Di(a, b),
      x;
    void 0 !== Ei && ((x = '&ual=' + Math.floor(Ei)), a && (Ei = void 0));
    return [
      g,
      l,
      m,
  ...
  var il = function (a, b, c) {
      if (E[a.functionName]) return b.yf && G(b.yf), E[a.functionName];
      var d = hl();
      E[a.functionName] = d;
      if (a.Yd)
        for (var e = 0; e < a.Yd.length; e++) E[a.Yd[e]] = E[a.Yd[e]] || hl();
      a.ne && void 0 === E[a.ne] && (E[a.ne] = c);
      ub(gl('https://', 'http://', a.Ff), b.yf, b.Mj);
      return d;
    },
    hl = function () {
      var a = function () {
    ...
    jl = {
      ...
      ne: '_googWcmAk',
      Ff: 'www.gstatic.com/wcm/loader.js',
    },
    kl = {
      functionName: '_gaPhoneImpl',
      ne: 'ga_wpid',
      Ff: 'www.gstatic.com/gaphone/loader.js',
    },
    ll = { Oh: '', Mi: '5' },
    ml = {
      functionName: '_googCallTrackingImpl',
      Yd: [kl.functionName, jl.functionName],
      Ff:
        ...
        for (
          ...
          nl[g.id] ||
            (g && 'AW' === g.prefix && !e.adData && 2 <= g.I.length
              ? ((e.adData = { ak: g.I[0], cl: g.I[1] }), (nl[g.id] = !0))
              : g &&
                'UA' === g.prefix &&
                !e.gaData &&
                ((e.gaData = { gaWpid: g.U }), (nl[g.id] = !0)));
        }
        (e.gaData || e.adData) && il(ml, d)(d.fb, e, d.options);
      }
    },
    ql = function () {
      var a = !1;
          ...
          if (!d || e) {
            ...
            if (m) {
              ...
              for (var w = 0; w < n.length; w++)
                if (w < v)
                  if (d) pl(d, n[w], t, { fb: u, options: r });
                  else if ('AW' === a.prefix && a.I[1])
                    ql()
                      ? pl([a], n[w], t || 'US', { fb: u, options: r })
                      : ol(a.I[0], a.I[1], n[w], { fb: u, options: r });
                  else if ('UA' === a.prefix)
                    if (ql()) pl([a], n[w], t || 'US', { fb: u });
                    else {
                      var y = a.U,
                        x = n[w],
                        A = { fb: u };
  ...
  var dv = function (a, b) {
      if (!b.C) {
        ...
        if (void 0 === e) {
          ...
          av.hasOwnProperty(c)
            ? (f = av[c])
            : bv.hasOwnProperty(c) && (f = bv[c]);
          1 === f && (f = cv(c));
          h(f)
            ? vo()(function () {
                var g = vo().getByName(a).get(f);
                d(g);
              })
            : d(void 0);
        } else d(e);
      ...
      if (Wf() && (!c.C || !fv[a])) {
        var d = !hg(R.g.R),
          e = function (f) {
            ...
            if (c.C || hv(b, n.createOnlyFields)) {
              c.C &&
                ((g = 'gtm' + te()),
              ...
              d &&
                ...
                ((d = !1),
                m(function () {
                  var t = vo().getByName(c.C ? g : b);
                  !t ||
                    (t.get('clientId') == p && q) ||
                    (c.C
                      ? ((n.fieldsToSet['&gcu'] = '1'),
                        (n.fieldsToSet['&gcut'] = Vd[f]))
                      : ((n.fieldsToSend['&gcu'] = '1'),
                        (n.fieldsToSend['&gcut'] = Vd[f])),
                    t.set(n.fieldsToSet),
                    c.C
                      ? t.send('pageview')
    ...
    sv = function (a, b, c) {
      ...
      var f = a,
        ...
        l = c.C ? xo(T(c, 'gaFunctionName')) : xo();
      if (oa(l)) {
        var m = vo,
          n;
        c.C
        ...
        var p = function (D) {
          ...
          q = function (D) {
            var K = function (aa, U) {
                for (var Q = 0; U && Q < U.length; Q++) p(aa, U[Q]);
              },
              M = c.C,
              S = M ? lv(u) : mv(b, c);
            if (S) {
              ...
              M && S.ff && p('set', '&cu', S.ff);
              var L = S.action;
              if (M || 'impressions' === L)
                if ((K('ec:addImpression', S.ph), !M)) return;
              if ('promo_click' === L || 'promo_view' === L || (M && S.hd)) {
                var N = S.hd;
                K('ec:addPromo', N);
                if (N && 0 < N.length && 'promo_click' === L) {
                  M ? p('ec:setAction', L, S.Sa) : p('ec:setAction', L);
                  return;
                }
                if (!M) return;
              }
              'promo_view' !== L &&
                'impressions' !== L &&
                (K('ec:addProduct', S.Bb), p('ec:setAction', L, S.Sa));
            }
          },
          r = function (D) {
            if (D) {
              var K = {};
              if (Kb(D))
                for (var M in nv) nv.hasOwnProperty(M) && ov(nv[M], M, D[M], K);
              jv(K, y);
              p('require', 'linkid', K);
            }
          },
          t = function () {
            if (Sg()) {
              ...
              var D = T(c, R.g.ni);
              D &&
                (p('require', D, { dataLayer: Yd.fa }), p('require', 'render'));
            }
          },
          u = gv(n, b, c),
          v = function (D, K, M) {
        ...
        !c.C &&
          hv(n, u.createOnlyFields) &&
          (l(function () {
            m() && m().remove(n);
          }),
          (pv[n] = !1));
        l('create', f, u.createOnlyFields);
        if (u.createOnlyFields[R.g.vb] && !c.C) {
          var w = In(u.createOnlyFields[R.g.vb], '/analytics.js');
          w && (g = w);
        }
        var y = c.C ? u.fieldsToSet[R.g.vb] : u.createOnlyFields[R.g.vb];
        if (y) {
          var x = c.C ? u.fieldsToSet[R.g.Id] : u.createOnlyFields[R.g.Id];
          x && !pv[n] && ((pv[n] = !0), l(Bo(n, x)));
        }
        c.C
        ...
        if (b === R.g.sc)
          if (c.C) {
            ...
            q(y);
            p('send', 'pageview');
            u.createOnlyFields._useUp && yo(n + '.');
          } else t(), p('send', 'pageview', u.fieldsToSend);
        else
          b === R.g.va
            ? (t(),
              rl(f, c),
              T(c, R.g.cb) && (Sk(['aw', 'dc']), yo(n + '.')),
      ...
      function c(f) {
        ...
        function l() {
          if (f.category) m.category = f.category;
            ...
            for (var n = '', p = 0; p < uv.length; p++)
              void 0 !== f[uv[p]] && (n && (n += '/'), (n += f[uv[p]]));
            n && (m.category = n);
          }
        }
        var m = J(f);
  ...
  var rv,
    ...
    zv = {},
    av = Object.freeze(
      ((zv.client_storage = 'storage'),
      (zv.sample_rate = 1),
      (zv.site_speed_sample_rate = 1),
      (zv.store_gac = 1),
    ...
    Bv = Object.freeze(
      ...
      (Av.cookiePath = 1),
      (Av.cookieUpdate = 1),
      (Av.legacyCookieDomain = 1),
      (Av.legacyHistoryImport = 1),
      (Av.name = 1),
      (Av.sampleRate = 1),
      (Av.siteSpeedSampleRate = 1),
      (Av.storage = 1),
      (Av.storeGac = 1),
      (Av.useAmpClientId = 1),
      (Av._cd2l = 1),
    ...
    Cv = Object.freeze({ anonymize_ip: 1 }),
    Dv = {},
    bv = Object.freeze(
      ((Dv.campaign = {
      ...
      (Dv.app_id = 1),
      (Dv.app_installer_id = 1),
      (Dv.app_name = 1),
      (Dv.app_version = 1),
      (Dv.description = 'exDescription'),
      (Dv.fatal = 'exFatal'),
      (Dv.language = 1),
      (Dv.page_hostname = 'hostname'),
      (Dv.transport_type = 'transport'),
      (Dv[R.g.ma] = 'currencyCode'),
      (Dv[R.g.rg] = 1),
      (Dv[R.g.Ka] = 'location'),
      (Dv[R.g.He] = 'page'),
      (Dv[R.g.La] = 'referrer'),
    ...
    Hv = {},
    nv = Object.freeze(
      ((Hv.levels = 1), (Hv[R.g.Ia] = 'duration'), (Hv[R.g.Bc] = 1), Hv)
    ),
    Iv = {},
    Jv = Object.freeze(
      ((Iv.anonymize_ip = 1),
    ...
    Kv = {},
    qv = Object.freeze(
      ((Kv.checkout_progress = 1),
      (Kv.select_content = 1),
      (Kv.set_checkout_option = 1),
      (Kv[R.g.mc] = 1),
      (Kv[R.g.nc] = 1),
      (Kv[R.g.Ib] = 1),
      (Kv[R.g.oc] = 1),
    ...
    Lv = {},
    Mv = Object.freeze(
      ((Lv.checkout_progress = 1),
      (Lv.set_checkout_option = 1),
      (Lv[R.g.Sf] = 1),
      (Lv[R.g.Tf] = 1),
      (Lv[R.g.mc] = 1),
      (Lv[R.g.nc] = 1),
    ...
    gv = function (a, b, c) {
      ...
      for (var r = Ql(c), t = 0; t < r.length; ++t) {
        var u = r[t];
        if (c.C) {
          var v = d(u);
          Gv.hasOwnProperty(u)
          ...
          var w = void 0;
          w = u !== R.g.aa ? d(u) : Rl(c, u);
          if (Fv.hasOwnProperty(u)) ov(Fv[u], u, w, e);
          else if (Cv.hasOwnProperty(u)) ov(Cv[u], u, w, g);
          else if (bv.hasOwnProperty(u)) ov(bv[u], u, w, f);
          else if (av.hasOwnProperty(u)) ov(av[u], u, w, l);
            ...
            b === R.g.va
              ? (x = La(Rl(c, u), '.'))
              : ((x = La(Rl(c, u, 1), '.')), (A = La(Rl(c, u, 2), '.')));
            x && (f['&gdid'] = x);
            A && (f['&edid'] = A);
          } else
            u === R.g.Pa && 0 > r.indexOf(R.g.Bc) && (l.cookieName = w + '_ga');
        }
      }
      (!1 !== d(R.g.ci) && !1 !== d(R.g.Lb) && bt()) ||
        (g.allowAdFeatures = !1);
      (!1 !== d(R.g.X) && ct()) || (g.allowAdPersonalizationSignals = !1);
      ...
      if (c.C) {
        ...
        kv(l, 'cookieDomain', 'auto');
        kv(g, 'forceSSL', !0);
        kv(e, 'eventCategory', Pv(b));
        Rv[b] && kv(f, 'nonInteraction', !0);
        'login' === b || 'sign_up' === b || 'share' === b
          ? kv(e, 'eventLabel', d(R.g.qg))
          : 'search' === b || 'view_search_results' === b
          ? kv(e, 'eventLabel', d(R.g.wi))
          : 'select_content' === b && kv(e, 'eventLabel', d(R.g.fi));
        var C = e[R.g.ra] || {},
          H = C[R.g.Qb];
        H || (0 != H && C[R.g.T])
          ? (l.allowLinker = !0)
          : !1 === H && kv(l, 'useAmpClientId', !1);
        f.hitCallback = c.O;
        l.name = a;
      }
      Wf() &&
        ((g['&gcs'] = ig()),
        hg(R.g.R) || (l.storage = 'none'),
        hg(R.g.F) || ((g.allowAdFeatures = !1), (l.storeGac = !1)));
    ...
    lv = function (a) {
      ...
      if (b.impressions) {
        ...
        var d = b.impressions;
        c.ph = 'impressions' === b.translateIfKeyEquals ? wv(d, !0) : d;
      }
      if (b.promoView) {
        c.action = 'promo_view';
        var e = b.promoView.promotions;
        c.hd = 'promoView' === b.translateIfKeyEquals ? wv(e, !0) : e;
      }
      if (b.promoClick) {
        c.action = 'promo_click';
        var f = b.promoClick.promotions;
        c.hd = 'promoClick' === b.translateIfKeyEquals ? wv(f, !0) : f;
      ...
      for (var g in b)
        if (
          ...
          c.action = g;
          var l = b[g].products;
          c.Bb = 'products' === b.translateIfKeyEquals ? wv(l, !0) : l;
    ...
    mv = function (a, b) {
      ...
      for (
        ...
        f &&
        l < f.length &&
        ((g = f[l][R.g.cg]), !g && vv && (g = f[l][R.g.ag]), !g);
        l++
      );
      var m = d(R.g.Dc);
      if (Kb(m))
      ...
      var r = null,
        t = d(R.g.li);
      if (a === R.g.Ba || a === R.g.qc) r = { action: a, Sa: c(), Bb: wv(f) };
      else if (a === R.g.mc) r = { action: 'add', Sa: c(), Bb: wv(f) };
      else if (a === R.g.nc) r = { action: 'remove', Sa: c(), Bb: wv(f) };
      else if (a === R.g.Ha) r = { action: 'detail', Sa: c(g), Bb: wv(f) };
      else if (a === R.g.sb) r = { action: 'impressions', ph: wv(f) };
      else if (a === R.g.tb)
        r = { action: 'promo_view', hd: vv ? wv(t) || wv(f) : wv(t) };
      else if (
        ('select_content' === a && t && 0 < t.length) ||
        (vv && a === R.g.Jb)
      )
        r = { action: 'promo_click', hd: vv ? wv(t) || wv(f) : wv(t) };
      else if ('select_content' === a || (vv && a === R.g.oc))
        r = { action: 'click', Sa: { list: e() || g }, Bb: wv(f) };
      else if (a === R.g.Ib || 'checkout_progress' === a) {
        var u = { step: a === R.g.Ib ? 1 : d(R.g.Zf), option: d(R.g.Yf) };
        r = { action: 'checkout', Bb: wv(f), Sa: J(c(), u) };
      } else
        'set_checkout_option' === a &&
          (r = {
            action: 'checkout_option',
            Sa: { step: d(R.g.Zf), option: d(R.g.Yf) },
          });
      r && (r.ff = d(R.g.ma));
      return r;
    },
      ...
      (function (a) {
        ...
        c
          ? (G(a.vtp_gtmOnSuccess),
            Lp.register(a.vtp_containerId, c),
            a.vtp_remoteConfig &&
              Up(a.vtp_containerId, a.vtp_remoteConfig || {}))
          : G(a.vtp_gtmOnFailure);
      });
    })();
  (Y.o.cid = ['google']),
  ...
  (Y.o.get = ['google']),
    (function () {
      (function (a) {
        ...
        var f = Oo(String(b.streamId), d, c);
        Ro(f, e.eventId, e);
        a.vtp_gtmOnSuccess();
      });
    })();

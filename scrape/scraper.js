...
exports.pinterestdl = async (url) => {
  return new Promise((resolve, reject) => {
    ...
    request(options, async function (error, response, body) {
      ...
      const $ = cheerio.load(body);
      const hasil = [];
      $('#showdata > div:nth-child(4) > table > tbody > tr ').each(function (
        a,
        b
      ) {
        const result = {
